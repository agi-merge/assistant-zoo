...
// Define your custom auto focus plugin
...
function EditorComponent({ value, onChange }: EditorProps) {
  ...
  return (
    <LexicalComposer initialConfig={initialConfig}>
      <PlainTextPlugin
        contentEditable={<ContentEditable value={value} onChange={onChange} />}
...
export default function SignInSide() {
  ...
  const handleEditorChange = useCallback(
    (value: React.FormEvent<HTMLDivElement>) => {
      setContent(value.currentTarget.textContent ?? "");
  ...
  return (
    <CssVarsProvider defaultMode="dark" disableTransitionOnChange>
      ...
      >
        ...
        <iframe
          src="https://www.loom.com/embed/d13d757a6efe44e7b27afa5f5fee9335?sid=7d23c1fd-df9e-4802-ac85-496d184bbf48"
          frameBorder="0"
